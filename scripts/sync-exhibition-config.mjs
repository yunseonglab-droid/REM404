...
const metadata = Object.fromEntries(Object.entries(document.fields || {}).map(([key, value]) => [key, decode(value)]));
await writeFile(new URL("../js/exhibition-snapshot.js", import.meta.url), `// Generated by REM404. Edit exhibition information in the REM404 app.\nexport const exhibitionSnapshot = Object.freeze(${JSON.stringify(metadata, null, 2)});\n`, "utf8");
await writeFile(new URL("../js/exhibition-snapshot.json", import.meta.url), `${JSON.stringify(metadata, null, 2)}\n`, "utf8");
